<style type="text/css">
    ...
    #mpesaForm .form-group {
        margin-bottom: 15px;
    }

    #mpesaForm .control-label {
        font-weight: 600;
        padding-top: 7px;
    }

    #mpesaForm .text-muted {
        font-size: 12px;
        margin-top: 5px;
        display: block;
    }

    #mpesaForm .btn-success {
        padding: 8px 20px;
        font-size: 14px;
    }

    #mpesaForm .text-danger {
        font-size: 12px;
        margin-top: 5px;
        display: block;
    }
                ...
                <div class="stutop" id="">
                    ...
                    <div class="studentsidetopfixed">
                        <p class="classtap"><?php echo $student["class"]; ?> <a href="#" data-toggle="control-sidebar"
                                class="studentsideclose"><i class="fa fa-times"></i></a></p>
                            ...
                            <?php foreach ($class_section as $skey => $svalue) {
                                ...
                                ?>>
                                    <a href="#section<?php echo $svalue["section_id"] ?>"
                                        data-toggle="tab"><?php print_r($svalue["section"]); ?></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
                ...
                " alt="No Image">
                        ...
                        <div class="row no-print mb10">
                            <div class="col-md-12 mDMb10">
                                ...
                                <span class="pull-right pt5"><?php echo $this->lang->line('date'); ?>:
                                                    ...
                                                    <tr class="white-td">
                                                        ...
                                                        <td class="text text-left">
                                                            ...
                                                            <a href="#" data-toggle="popover" class="detail_popover">
                                                                <?php echo $transport_fee_value->student_fees_deposite_id . "/" . $fee_deposits_value->inv_no; ?></a>
                                                            <div class="fee_detail_popover" style="display: none">
                                                                <?php
                                                                if ($fee_deposits_value->description == "") {
                                                                    ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                ...
                                (<?php echo $currency_symbol; ?>)<small class="req"> *</small></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="inputPassword3"
                                class="col-sm-3 control-label"><?php echo $this->lang->line('discount'); ?>
                                (<?php echo $currency_symbol; ?>)<small class="req"> *</small></label>
                            <div class="col-sm-9">
                                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee" value="Cash"
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="payment_mode_fee"
                        ...
                        <!-- M-Pesa Form (Hidden by default, shown when M-Pesa is selected) -->
                        <div id="mpesaForm"
                            style="display: none; margin-top: 15px; padding: 15px; background: #f9f9f9; border-radius: 5px;">
                            <form method="post" action="<?php echo site_url('mpesa/process'); ?>" id="mpesaPaymentForm"
                                class="form-horizontal">
                                <div class="form-group">
                                    <label for="phone"
                                        class="col-sm-3 control-label"><?php echo $this->lang->line('phone_number'); ?><small
                                            class="req"> *</small></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="phone" id="phone" class="form-control" required
                                            placeholder="e.g., 2547XXXXXXXX" pattern="\+?[0-9]{10,12}">
                                        <small
                                            class="text-muted"><?php echo $this->lang->line('enter_mpesa_phone'); ?></small>
                                ...
                                <div class="form-group">
                                    <label for="amount"
                                        ...
                                        (<?php echo $currency_symbol; ?>)<small class="req"> *</small></label>
                                    <div class="col-sm-9">
                                        <input type="number" name="amount" id="mpesa_amount" class="form-control"
                                            value="<?php echo amountFormat($total_balance_amount - $alot_fee_discount); ?>"
                                            min="1" step="1" required>
                                        <small
                                            class="text-muted"><?php echo $this->lang->line('enter_amount_to_pay'); ?>
                                            (<?php echo $this->lang->line('minimum'); ?>: 1)</small>
                                        <span class="text-danger" id="amount_error"></span>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="collected_date"
                                    value="<?php echo date($this->customlib->getSchoolDateFormat()); ?>">
                                <input type="hidden" name="fee_gupcollected_note" id="fee_gupcollected_note" value="">
                                <?php
                                $index = 0;
                                foreach ($student_due_fee as $fee_key => $fee_value) {
                                    foreach ($fee_value->fees as $feetype_key => $feetype_value) {
                                        $feetype_balance = $feetype_value->amount - ($feetype_value->amount_paid + $feetype_value->amount_discount);
                                        if ($feetype_balance > 0) {
                                            $index++;
                                            ?>
                                            <input type="hidden" name="row_counter[]" value="<?php echo $index; ?>">
                                            <input type="hidden" name="student_fees_master_id_<?php echo $index; ?>"
                                                value="<?php echo $feetype_value->id; ?>">
                                            <input type="hidden" name="fee_groups_feetype_id_<?php echo $index; ?>"
                                                value="<?php echo $feetype_value->fee_groups_feetype_id; ?>">
                                            <input type="hidden" name="fee_groups_feetype_fine_amount_<?php echo $index; ?>"
                                                value="<?php echo $feetype_value->fine_amount; ?>">
                                            <input type="hidden" name="fee_amount_<?php echo $index; ?>"
                                                value="<?php echo $feetype_value->amount; ?>">
                                            <input type="hidden" name="fee_category_<?php echo $index; ?>" value="fees">
                                            <input type="hidden" name="trans_fee_id_<?php echo $index; ?>" value="0">
                                        <?php } ?>
                                    <?php } ?>
                                <?php } ?>
                                <?php foreach ($transport_fees as $trans_key => $trans_value) {
                                    $trans_balance = $trans_value->fees - ($trans_value->amount_paid + $trans_value->amount_discount);
                                    if ($trans_balance > 0) {
                                        $index++;
                                        ?>
                                        <input type="hidden" name="row_counter[]" value="<?php echo $index; ?>">
                                        <input type="hidden" name="student_fees_master_id_<?php echo $index; ?>" value="0">
                                        <input type="hidden" name="fee_groups_feetype_id_<?php echo $index; ?>" value="0">
                                        <input type="hidden" name="fee_groups_feetype_fine_amount_<?php echo $index; ?>"
                                            value="<?php echo $trans_value->fine_amount; ?>">
                                        <input type="hidden" name="fee_amount_<?php echo $index; ?>"
                                            value="<?php echo $trans_value->fees; ?>">
                                        <input type="hidden" name="fee_category_<?php echo $index; ?>" value="transport">
                                        <input type="hidden" name="trans_fee_id_<?php echo $index; ?>"
                                            value="<?php echo $trans_value->id; ?>">
                                    <?php } ?>
                                <?php } ?>
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <button type="submit" class="btn btn-success" id="payMpesaBtn"
                                            data-loading-text="<i class='fa fa-spinner fa-spin'></i> <?php echo $this->lang->line('processing'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn cfees save_button" id="load" data-action="print"
                                    ...
                                    <?php echo $this->lang->line('collect_print'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb0">
                                <div class="form-horizontal">
                                    <div class="box-body">
                                        <input type="hidden" class="form-control" id="student_fees_discount_id"
                                            value="" />
                                        <div class="form-group">
                                            <label for="inputPassword3"
                                                class="col-sm-3 control-label"><?php echo $this->lang->line('payment_id'); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="3" id="dis_description"
                ...
                <div class="delmodal modal fade" id="confirm-discountdelete" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><?php echo $this->lang->line('are_you_sure_want_to_revert'); ?> <b
                                        class="discount_title"></b>
                ...
                <div class="delmodal modal fade" id="confirm-delete" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <p><?php echo $this->lang->line('are_you_sure_want_to_delete'); ?> <b
                                        class="invoice_no"></b>
                ...
                <div class="norecord modal fade" id="confirm-norecord" tabindex="-1" role="dialog"
                    aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body">
                ...
                <div id="listCollectionModal" class="modal fade">
                    <div class="modal-dialog">
                        <form action="<?php echo site_url('studentfee/addfeegrp'); ?>" method="POST"
                            id="collect_fee_group">
                            <div class="modal-content">
                                <!-- //================ -->
                                <input type="hidden" class="form-control" id="group_std_id" name="student_session_id"
                                    value="<?php echo $student["student_session_id"]; ?>" readonly="readonly" />
                                <input type="hidden" class="form-control" id="group_parent_app_key"
                                    name="parent_app_key" value="<?php echo $student['parent_app_key'] ?>"
                                    readonly="readonly" />
                                <input type="hidden" class="form-control" id="group_guardian_phone"
                                    name="guardian_phone" value="<?php echo $student['guardian_phone'] ?>"
                                    readonly="readonly" />
                                <input type="hidden" class="form-control" id="group_guardian_email"
                                    name="guardian_email" value="<?php echo $student['guardian_email'] ?>"
                                    readonly="readonly" />
                                <!-- //================ -->
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                ...
                <!-- Script to show the mpesa input details Conditionally -->
                <script>
