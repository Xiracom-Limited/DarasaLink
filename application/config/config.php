...
|
*/
$config['encryption_key'] = 'darasalink_encryption_key';
...
| 'sess_samesite'
|
|	The session cookie samesite attribute: Lax (default), Strict or None
|
| 'sess_expiration'
|
...
$config['sess_save_path'] = ini_get('upload_tmp_dir') ? ini_get('upload_tmp_dir') : sys_get_temp_dir();
